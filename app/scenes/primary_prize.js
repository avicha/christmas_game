...
export default class PrimaryPrize extends Scene {
    constructor(game, opts) {
        ...
        this.primary_title = this.addGameObject(new Sprite(-resources.primary_title.sizeWidth / 2, 263, 1, {
            texture: resources.primary_title,
            fixed: 'top-center'
        }))
        this.help_btn = this.addGameObject(new Sprite(-15 - resources.help_btn.sizeWidth, 455, 1, {
            texture: resources.help_btn,
            fixed: 'top-center'
        }))
        this.again_btn = this.addGameObject(new Sprite(15, 455, 1, {
