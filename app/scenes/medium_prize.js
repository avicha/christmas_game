...
export default class MediumPrize extends Scene {
    constructor(game, opts) {
        ...
        this.medium_title = this.addGameObject(new Sprite(game.renderStageZone.pivot.x - resources.medium_title.sizeWidth / 2, game.renderStageZone.top + 257, 1, {
            texture: resources.medium_title
        }))
        this.coupon_btn = this.addGameObject(new Sprite(game.renderStageZone.pivot.x - resources.invite_btn.sizeWidth / 2 - 30 - resources.coupon_btn.sizeWidth, game.renderStageZone.top + 457, 1, {
            texture: resources.coupon_btn
        }))
        this.invite_btn = this.addGameObject(new Sprite(game.renderStageZone.pivot.x - resources.invite_btn.sizeWidth / 2, game.renderStageZone.top + 457, 1, {
            texture: resources.invite_btn
        }))
        this.again_btn = this.addGameObject(new Sprite(game.renderStageZone.pivot.x + resources.invite_btn.sizeWidth / 2 + 30, game.renderStageZone.top + 457, 1, {
